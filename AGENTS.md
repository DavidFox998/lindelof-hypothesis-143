# AGENTS.md — lindelof-hypothesis-143

## Role: LINDELOF-CLUSTER

**Cluster:** Lindelöf Hypothesis

**Core claim:** Moment bounds and sub-convexity for ζ(1/2+it) — connects to RH cluster
...
expressed in the language of Lindelöf Hypothesis.

## Entry point for AI agents

Look for `Lindelof` Lean files.
